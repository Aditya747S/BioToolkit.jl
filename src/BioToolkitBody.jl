...
using .HiC: CoolMeta, HiCContactMatrix, HiCBounds, HiCExperiment, read_cool, read_hic, write_cool, normalize_ice, normalize_kr, normalize_vanilla, expected_decay, power_law_fit, obs_exp_ratio, insulation_score as hic_insulation_score, boundary_detection, boundary_strength, compartment_score, ab_compartments, compartment_switching, differential_interaction, hic_diff_test, call_loops, merge_loops, loop_apa, pileup_matrix, contact_decay_by_distance, chromosome_contact_map, hic_quality_metrics
